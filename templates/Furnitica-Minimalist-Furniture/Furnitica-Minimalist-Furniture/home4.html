                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="item text-center col-20">
                                        <div class="product-miniature js-product-miniature item-one first-item">
                                            <div class="thumbnail-container">
                                                <a href="product-detail.html">
                                                    <img class="img-fluid image-cover" src="img/product/18.jpg" alt="img">
                                                    <img class="img-fluid image-secondary" src="img/product/14.jpg" alt="img">
                                                </a>
                                                <div class="highlighted-informations">
                                                    <div class="variant-links">
                                        ...
                                        <div class="product-miniature js-product-miniature item-one first-item">
                                            <div class="thumbnail-container">
                                                <a href="product-detail.html">
                                                    ...
                                                    <img class="img-fluid image-secondary" src="img/product/20.jpg" alt="img">
                                                </a>
                                                <div class="highlighted-informations">
                                                    <div class="variant-links">
                                                        <a href="#" class="color beige" title="Beige"></a>
                    ...
                    <div class="block">
                        <div class="block-content">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">COFFEE TABLE</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">SHELF</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">SOFA</a>
                                </li>
                                <li class="list-inline-item">
                    ...
                    <div class="block">
                        <div class="block-content">
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">WINDOW CURTAIN</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">CHANDELIER</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">CEILING FAN </a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">WARDROBE</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">FLOOR LAMP</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">VASE FLOWER</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">SIDE TABLE</a>
                                </li>
                                ...
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">TABLE LAMP</a>
                                </li>
                                <li class="list-inline-item">
                                    <a href="product-grid-sidebar-left.html">ARMCHIRM</a>
                                </li>
                                <li class="list-inline-item views">
                                    <a href="product-grid-sidebar-left.html">VIEW ALL</a>
                                </li>
